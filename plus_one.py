...
# significant in left-to-right order. The large integer
...
def main():
    ...
    expected = [[1,2,4],[4,3,2,2],[1,0],[1,2,0,0]]

    solution = Solution()

    #Tests
    for i, v in enumerate(inputs):
        result = solution.plusOne2(v)
        print(f"Expected: {expected[i]} Result: {result}")
